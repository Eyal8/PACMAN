  ...
  }, 'Just another dot followed by something.');
  $.validator.addMethod('dateOfBirth', function(value, element) {
    ...
    return this.optional(element)
      ...
      && month <= mm
      && day <= dd;
  }, 'There is no way you were born in this date.');
  $.validator.addMethod('numOfPoints', function(value, element) {
    return this.optional(element)
      || value >=50
      && value <= 90;
  }, 'You must choose a number between 50 and 90');

  $.validator.addMethod('minTime', function(value, element) {
    return this.optional(element)
      || value >= 60;
  }, 'You must play at least for a whole minute!');
